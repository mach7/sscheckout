...
add_action('plugins_loaded', function () {
    ...
    if ( class_exists( 'FLW_Plugin_Library' ) ) {
        ...
        class SimpleShoppingCart_Plugin {
             ...
             * Displays the cart items and a checkout form.
             */
             ...
             *
             * Uses the PaymentIntents API if a PaymentMethod is provided.
             */
            public function process_checkout() {
                ...
                // If a PaymentMethod is provided from the client (via Stripe Elements).
                if ( isset( $_POST['paymentMethod'] ) && ! empty( $_POST['paymentMethod'] ) ) {
                    $payment_method = sanitize_text_field( wp_unslash( $_POST['paymentMethod'] ) );
                    ...
                    if ( $pi_result['status'] == 'succeeded' ) {
                        $payment_status = 'Payment successful and order processed.';
                    } elseif ( $pi_result['status'] == 'requires_action' ) {
                        $payment_status = 'Payment requires additional authentication.';
                    } else {
                ...
                wp_send_json_success( $payment_status );
            }

            /**
             * Register an admin submenu under FLW Plugins.
             */
            public function register_submenu() {
                FLW_Plugin_Library::add_submenu(
                    'Shopping Cart Settings', // {PLUGIN_SETTINGS_TITLE}
                    'simple-shopping-cart',   // {PLUGIN_SLUG}
